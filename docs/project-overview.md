...
| What is the current material strategy? | [`review/asset-rights-readiness-packet.md`](review/asset-rights-readiness-packet.md) | Owner composition pass, 14-requirement plan, 28-reference evidence separation, minimum set, and the next compressed decision. |
...
| --- | --- | --- | --- |
| Asset / Rights Readiness Packet | Active H0; Owner whole-story composition pass recorded; 14/14 requirements and 19/19 shots mapped; 28 references / 36 aliases / 42 assignments; all Owner decisions unselected | [`review/asset-rights-readiness-packet.md`](review/asset-rights-readiness-packet.md) | `artifacts/asset-rights-readiness-packet/`, green result, 900x1200 Dark and 1280x900 Light screenshots |
| Integrated Visual Production Package | Preserved accepted composition authority; exact 6 Beats / 19 shots / 180 seconds; 28 references / 42 assignments / 5 lineages / no copied raster; Owner whole-story review passed | [`review/integrated-visual-production-package.md`](review/integrated-visual-production-package.md) | `artifacts/integrated-visual-production-package/`, green result, 19-cell contact sheet, 900x1200 Dark and 1280x900 Light screenshots |
| Composition Expansion Wave 2 | Preserved H0 source; Beats 5/6 supplied the final seven concrete shots used by the active integrated package | [`review/composition-expansion-wave2.md`](review/composition-expansion-wave2.md) | `artifacts/composition-expansion-wave2/`, preserved green result, contact sheet, 900x1200 Dark and 1280x900 Light screenshots |
| Composition Expansion Wave 1 | Preserved H0 predecessor; Beats 1 and 3 supplied six of the 19 now-concrete source shots; no post-Wave-1 human gate | [`review/composition-expansion-wave1.md`](review/composition-expansion-wave1.md) | `artifacts/composition-expansion-wave1/`, preserved green result, 900x1200 Dark and 1280x900 Light screenshots |
