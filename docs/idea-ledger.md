...
- State: H0 machine validation is green with 24/24 fail-closed probes, 6/6 provenance/dimension/hash checks, two measured viewports, theme/layout/print-style evidence, manifest integrity, and unchanged sources. Human visual-treatment comprehension remains inferred.
