...
- Artifact id: `fff-operator-production-brief-001`
...
- The immediate user-side work is H1 Human Comprehension Review: open `public/review/index.html?mode=blueprint` once and explain in freeform what is being made, its scale, how the six-part story progresses, how it should look and move, and what observable state counts as complete. Narration rehearsal, asset/shot brief generation, actual asset selection, production, rights clearance, and canon remain deferred or blocked.
...
| --- | --- | --- |
| Operator Production Brief | `fff-operator-production-brief-001` is active; four normal-flow sections translate the protected six-beat / 19-shot / 20-subtitle contract into one non-specialist instruction path | Perform H1 comprehension review once; only a separate authorization may open narration rehearsal, asset/shot work, or production gates |
...
Use review memory before asking for another review. The next non-redundant move is H1 Human Comprehension Review: inspect `mode=blueprint` once and answer in freeform what is being made, how large it is, how the six-part story progresses, how it should look and move, and when it is complete. Narration rehearsal for beats 1/3/4/6, H2 asset/shot work, separate-creator testing, old-branch audit, Stale Shelf Excision, final canon, timing/order or truth changes, asset selection, rights clearance, provider, generation, render, upload, publication, database, and additional adoption remain deferred or require separate authorization.
