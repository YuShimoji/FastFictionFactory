...
- Artifact id: `fff-bridge-refinement-overview-ribbon-001`
- Review UI: `public/review/index.html`
- Home Cockpit / Review Brief mode: `public/review/index.html?mode=brief`
...
- `public/review/index.html` and `public/review/index.html?mode=brief` now default to the Home Cockpit command surface. `public/review/index.html?mode=home` remains a compatibility alias to the same screen.
...
- Human freeform review of the Latest Overview Report and Draft-to-Video Bridge remains the immediate next user-side work: accept, revise, or reject the route, narration, subtitle rhythm, visual order, thumbnail direction, and held-truth policy.
...
| --- | --- | --- |
| Bridge Refinement Overview Ribbon | Covered by `fff-bridge-refinement-overview-ribbon-001`; `public/review/index.html?mode=brief` starts with the 5-item Latest Overview Report, the legacy Brief is folded, and `public/review/index.html?mode=bridge` carries non-final narration/subtitle/visual/thumbnail/held-truth refinement cues | Human reviewer should read the overview first, then Bridge, and respond freeform with accept / revise / reject for route, narration, subtitle rhythm, visual order, thumbnail direction, and held-truth policy |
